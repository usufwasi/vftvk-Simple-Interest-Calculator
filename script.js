function compute()
{
    ...
    */
    ...
    result_span.innerHTML = "If you deposit <span class='highlight'>"+principal+"</span><br>at an interest rate of <span class='highlight'>"+rate+"%</span>,<br>You will receive an amount of <span class='highlight'>"+amount+"</span>,<br>in the year "+year;
